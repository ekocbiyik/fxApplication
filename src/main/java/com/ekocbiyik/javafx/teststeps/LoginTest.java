...
public class LoginTest {
    ...
    private String testName = TestFieldsIDs.LOGIN_TEST;
    ...
    public Map<String, Object> execute(Map<String, Object> mainContext) {
        ...
        loginTest.setTestStatus(ETestStatus.PASS);
        mainContext.put(TestFieldsIDs.LOGIN_TEST, loginTest);
